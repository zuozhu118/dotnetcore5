...
var FullCalendar = (function (exports) {
      ...
      (n = u.sort(function (n, l) {
        ...
        n.some(function (n) {
          ...
          n.__d &&
            ((r = (o = (l = n).__v).__e),
            (f = l.__P) &&
              ((u = []), ((i = s({}, o)).__v = o.__v + 1), (t = $(f, o, i, l.__n, void 0 !== f.ownerSVGElement, null != o.__h ? [r] : null, u, null == r ? _(o) : r, o.__h)), j(u, o), t != r && w(o)))
        })
  }
    ...
    for (s == f && (s = null != r ? r[0] : P ? _(i, 0) : null), u.__k = [], y = 0; y < l.length; y++)
      if (
        ...
        ;(g = $(n, k, (w = w || f), t, o, r, c, s, v)),
          ...
          null != g
            ? (null == m && (m = g), (s = x(n, k, w, A, r, g, s)), v || 'option' != u.type ? 'function' == typeof u.type && (u.__d = s) : (n.value = ''))
      ...
      n: if ('function' == typeof P) {
        if (
          ...
          i.__c
            ...
            : ('prototype' in P && P.prototype.render ? (u.__c = v = new P(g, x)) : ((u.__c = v = new d(g, x)), (v.constructor = P), (v.render = M)),
              b && b.sub(v),
              (v.props = g),
              v.state || (v.state = {}),
              (v.context = x),
          ...
          null != P.getDerivedStateFromProps && (v.__s == v.state && (v.__s = s({}, v.__s)), s(v.__s, P.getDerivedStateFromProps(g, v.__s))),
          (y = v.props),
          (_ = v.state),
          h)
        )
          ...
          if (
            (null == P.getDerivedStateFromProps && g !== y && null != v.componentWillReceiveProps && v.componentWillReceiveProps(g, x),
  ...
  function H(n, l, u, i, t, o, r, c) {
    ...
    if (null === l.type) p === d || (c && n.data === d) || (n.data = d)
      ...
      A(n, d, p, t, c),
        h ? (l.__k = []) : ((s = l.props.children), m(n, Array.isArray(s) ? s : [s], l, u, i, 'foreignObject' !== l.type && t, o, r, f, c)),
        c ||
  ...
  function rangeContainsRange(outerRange, innerRange) {
    return (
      (outerRange.start === null || (innerRange.start !== null && innerRange.start >= outerRange.start)) && (outerRange.end === null || (innerRange.end !== null && innerRange.end <= outerRange.end))
    )
  }
  ...
  function buildDateEnv(settings) {
    var locale = buildLocale(settings.locale || 'zh-cn', organizeRawLocales([]).map) // TODO: don't hardcode 'en' everywhere
    return new DateEnv(
      __assign(
        __assign(
          {
  ...
  var CalendarDataManager = /** @class */ (function () {
    ...
    CalendarDataManager.prototype.processRawViewOptions = function (viewSpec, pluginHooks, localeDefaults, optionOverrides, dynamicOptionOverrides) {
      ...
      var refiners = __assign(
        __assign(__assign(__assign(__assign(__assign({}, BASE_OPTION_REFINERS), CALENDAR_LISTENER_REFINERS), CALENDAR_OPTION_REFINERS), VIEW_OPTION_REFINERS), pluginHooks.listenerRefiners),
        pluginHooks.optionRefiners
      )
      var refined = {}
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype.sliceNowDate = function (
      ...
      return this._sliceDateSpan.apply(this, __spreadArrays([{ range: { start: date, end: addMs(date, 1) }, allDay: false }, {}, context], extraArgs))
    }
    Slicer.prototype._sliceBusinessHours = function (businessHours, dateProfile, nextDayThreshold, context) {
      ...
      return this._sliceEventStore.apply(
        this,
        __spreadArrays([expandRecurring(businessHours, computeActiveRange(dateProfile, Boolean(nextDayThreshold)), context), {}, dateProfile, nextDayThreshold], extraArgs)
      ).bg
    }
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    SimpleScrollGrid.prototype.render = function () {
      ...
      return createElement(
        ...
        Boolean(!isBuggy && headSectionNodes.length) && createElement.apply(void 0, __spreadArrays(['thead', {}], headSectionNodes)),
        Boolean(!isBuggy && bodySectionNodes.length) && createElement.apply(void 0, __spreadArrays(['tbody', {}], bodySectionNodes)),
        Boolean(!isBuggy && footSectionNodes.length) && createElement.apply(void 0, __spreadArrays(['tfoot', {}], footSectionNodes)),
          ...
          return createElement(
            ...
            createElement(
              ...
              props.showWeekNumber &&
                createElement(WeekNumberRoot, { date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (weekElRef, weekClassNames, innerElRef, innerContent) {
                  return createElement(
                    'a',
                    __assign(
                      {
  ...
  var TableListItemEvent = /** @class */ (function (_super) {
    ...
    TableListItemEvent.prototype.render = function () {
      ...
      return createElement(
        ...
        function (rootElRef, classNames, innerElRef, innerContent, innerProps) {
          // TODO 此处增加了style
          return createElement(
            'a',
            __assign(
  ...
  var TableRow = /** @class */ (function (_super) {
    ...
    TableRow.prototype.render = function () {
      ...
      var selectedInstanceHash = (props.eventDrag && props.eventDrag.affectedInstances) || (props.eventResize && props.eventResize.affectedInstances) || {} // TODO: messy way to compute this
      return createElement(
        'tr',
        { ref: this.rootElRef },
          ...
          return createElement(
            ...
            !props.forPrint &&
              ...
              createElement(MorePopover, {
                ...
                // yuck
                hiddenInstances: (props.eventDrag ? props.eventDrag.affectedInstances : null) || (props.eventResize ? props.eventResize.affectedInstances : null) || {},
                todayRange: todayRange,
              })
          )
        })
  ...
  var DayTable = /** @class */ (function (_super) {
    ...
    DayTable.prototype.render = function () {
      ...
      return createElement(
        Table,
        __assign({ ref: this.tableRef, elRef: this.handleRootEl }, this.slicer.sliceProps(props, props.dateProfile, props.nextDayThreshold, context, props.dayTableModel), {
          dateProfile: props.dateProfile,
    ...
    TimeColsSlats.prototype.updateSizing = function () {
      ...
      if (
        ...
        if (rootEl.offsetHeight) {
          // not hidden by css
          props.onCoords(
            new TimeColsSlatsCoords(new PositionCache(this.rootElRef.current, collectSlatEls(this.slatElRefs.currentMap, props.slatMetas), false, true), this.props.dateProfile, props.slatMetas)
          )
        }
      }
    }
  ...
  var TimeCol = /** @class */ (function (_super) {
    ...
    TimeCol.prototype.render = function () {
      ...
      var interactionAffectedInstances = (props.eventDrag && props.eventDrag.affectedInstances) || (props.eventResize && props.eventResize.affectedInstances) || {} // TODO: messy way to compute this
      return createElement(
        DayCellRoot,
        {
          elRef: props.elRef,
  ...
  var DayTimeCols = /** @class */ (function (_super) {
    ...
    DayTimeCols.prototype.render = function () {
      ...
      return createElement(NowTimer, { unit: isNowIndicator ? 'minute' : 'day' }, function (nowDate, todayRange) {
        return createElement(
          TimeCols,
          __assign({ ref: _this.timeColsRef, rootElRef: _this.handleRootEl }, _this.slicer.sliceProps(props, dateProfile, null, context, dayRanges), {
            forPrint: props.forPrint,
            axis: props.axis,
            dateProfile: dateProfile,
            slatMetas: props.slatMetas,
  ...
  BASE_OPTION_DEFAULTS.locale = 'zh-cn'
