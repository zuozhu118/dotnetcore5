...
(function () {
    ...
    editTable.prototype = {
        init: function () {
            ...
            me.setBorderWidth(me.getBorderWidth());
            ...
            domUtils.on(borderWidth, "change", function () {
                me.setBorderWidth(borderWidth.value);
            });
        },
        ...
        getBorderWidth: function () {
            debugger;
            var start = editor.selection.getStart(), width,
                cell = domUtils.findParentByTagName(start, ["td", "th", "caption"], true);
            width = cell && domUtils.getComputedStyle(cell, "border-width");
            if (!width || width == "initial" || width =="1.11111px") width = "1px";
            return width;
        },
    ...
    dialog.onok = function () {
        ...
        editor.execCommand("edittable", borderWidth.value);
